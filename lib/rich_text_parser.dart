        ...
        switch (node.localName) {
          case "a":
            ...
            if (_hasBlockChild(node)) {
              ...
              TextStyle _linkStyle = parseContext.childStyle.merge(
                getLinkStyle?.call(node) ?? DEFAULT_LINK_STYLE,
              );
              ...
              nextContext.childStyle = getLinkStyle?.call(node) ?? DEFAULT_LINK_STYLE;
